...
import com.github.chrisbanes.photoview2.PhotoViewAttacher;
...
public class ImagePagerAdapter extends PagerAdapter {
    ...
    public ImagePagerAdapter(Context context, List<Media> imgList) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        final Media image = mImgList.get(position);
    ...
    public interface OnItemClickListener {
        void onItemClick(int position, Media image);
    }
