...
import com.donkingliang.imageselector2.adapter.ImagePagerAdapter;
...
import com.donkingliang.imageselector2.view.MyViewPager;
...
public class PreviewActivity extends AppCompatActivity {
    ...
    public static void openActivity(Activity activity, ArrayList<Media> images,
                                    ArrayList<Media> selectImages, boolean isSingle,
    ...
    private void initViewPager() {
        ...
        adapter.setOnItemClickListener(new ImagePagerAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(int position, Media image) {
                if (isShowBar) {
                    hideBar();
                } else {
                    showBar();
    ...
    private void clickSelect() {
        ...
        if (mImages != null && mImages.size() > position) {
            Media image = mImages.get(position);
    ...
    private void changeSelect(Media image) {
