...
public class RequestConfig implements Parcelable {
    ...
    public int minSelectCount = 0; //图片的最大选择数量，小于等于0时，不限数量，isSingle为false时才有用。
    ...
    public ImageModel.Type type = ImageModel.Type.All;
