package com.donkingliang.imageselector2.utils;
...
import com.donkingliang.imageselector2.ClipImageActivity;
...
public class ImageSelector {
    ...
    public static class ImageSelectorBuilder {
        ...
        public ImageSelectorBuilder setMinSelectCount(int minSelectCount) {
            config.minSelectCount = minSelectCount;
            return this;
        }
        ...
        public ImageSelectorBuilder setType(ImageModel.Type type_){
            config.type = type_;
            return this;
        }
